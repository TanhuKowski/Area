...
namespace Area
{
    public partial class Form_Circle : Form
    {
        ...
        private void Form_Circle_Load(object sender, EventArgs e)
        {

        }

        private void Form_Circle_Load_1(object sender, EventArgs e)
        {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    float Area = PI * float.Parse(textBox2.Text) * float.Parse(textBox2.Text);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (float.Parse(textBox2.Text) > 0)
                {
                    float Perimeter = 2 * PI * float.Parse(textBox2.Text);
